...
import { Box, Card, Container, Flex, Heading, Table } from "@radix-ui/themes";
    ...
    return (
        <Flex>
            ...
            <Container m="7">
                ...
                <Heading m="5" align="center" size="8" weight="bold" style={{ color: "teal", textShadow: "1px 1px 2px black" }}>{profile.first_name}'s Order History</Heading>
